...
public sealed class GtaVKernelContractExportsTests
{
    ...
    [Fact]
    public void ContractClassAndGeneratedRegistryContainExactlyThe27Gen5HleRegistrations()
    {
        var attributes = typeof(GtaVKernelContractExports)
        ...
        Assert.Equal(27, attributes.Length);
        Assert.Equal(27, attributes.Select(attribute => attribute.Nid).Distinct(StringComparer.Ordinal).Count());
        ...
        Assert.DoesNotContain(expectedNids, gen4Nids.Contains);
    ...
    public void NanosleepPreservesThePosixTimespecContractOnSuccessAndFailure()
    {
        ...
        Assert.Equal((int)OrbisGen2Result.ORBIS_GEN2_OK, GtaVKernelContractExports.Nanosleep(context));
        ...
        Assert.Equal(
            ...
            GtaVKernelContractExports.Nanosleep(context));
    ...
    public void RmdirRemovesAnEmptyDirectoryAndMapsMissingPathToPosixFailure()
    {
        ...
        try
        {
            ...
            var context = new CpuContext(memory, Generation.Gen5);
            context[CpuRegister.Rdi] = memory.WriteCString(MemoryBase + 0x100, directory);

            Assert.Equal((int)OrbisGen2Result.ORBIS_GEN2_OK, GtaVKernelContractExports.Rmdir(context));
            Assert.Equal(0UL, context[CpuRegister.Rax]);
            Assert.False(Directory.Exists(directory));

            Assert.Equal(
                (int)OrbisGen2Result.ORBIS_GEN2_ERROR_NOT_FOUND,
                GtaVKernelContractExports.Rmdir(context));
            Assert.Equal(ulong.MaxValue, context[CpuRegister.Rax]);
        }
        finally
        {
    ...
    public void UnlinkRemovesAFileAndMapsMissingPathToPosixFailure()
    {
        ...
        try
        {
            var memory = new FakeCpuMemory(MemoryBase, 0x2000);
            var context = new CpuContext(memory, Generation.Gen5);
            context[CpuRegister.Rdi] = memory.WriteCString(MemoryBase + 0x100, file);

            Assert.Equal((int)OrbisGen2Result.ORBIS_GEN2_OK, GtaVKernelContractExports.Unlink(context));
            Assert.Equal(0UL, context[CpuRegister.Rax]);
            Assert.False(File.Exists(file));

            Assert.Equal(
                (int)OrbisGen2Result.ORBIS_GEN2_ERROR_NOT_FOUND,
                GtaVKernelContractExports.Unlink(context));
            Assert.Equal(ulong.MaxValue, context[CpuRegister.Rax]);
        }
        finally
        {
    ...
    public void DebugExceptionInfoIsAnIntentionalNoOutputDiagnosticSink()
    {
        ...
        Assert.Equal(
            ...
            GtaVKernelContractExports.DebugWriteCppExceptionInfo(context));
    ...
    public void InetNtopWritesCanonicalIpv4AndIpv6Text(string addressText, int addressFamily)
    {
        ...
        Assert.Equal((int)OrbisGen2Result.ORBIS_GEN2_OK, GtaVKernelContractExports.InetNtop(context));
    ...
    public void InetNtopReturnsNullAndLeavesDestinationUntouchedWhenCapacityIsTooSmall()
    {
        ...
        Assert.Equal(
            (int)OrbisGen2Result.ORBIS_GEN2_ERROR_INVALID_ARGUMENT,
            GtaVKernelContractExports.InetNtop(context));
        Assert.Equal(0UL, context[CpuRegister.Rax]);
    ...
    public async Task GetpeernameWritesTheConnectedPeerAndInvalidFdDoesNotWrite()
    {
        ...
        Assert.Equal((int)OrbisGen2Result.ORBIS_GEN2_OK, GtaVKernelContractExports.Getpeername(socket.Context));
        ...
        Assert.Equal(
            (int)OrbisGen2Result.ORBIS_GEN2_ERROR_NOT_FOUND,
            GtaVKernelContractExports.Getpeername(socket.Context));
    ...
    public async Task RecvCopiesConnectedTcpBytesAndInvalidFdDoesNotWrite()
    {
        ...
        Assert.Equal((int)OrbisGen2Result.ORBIS_GEN2_OK, GtaVKernelContractExports.Recv(socket.Context));
        ...
        Assert.Equal(
            (int)OrbisGen2Result.ORBIS_GEN2_ERROR_NOT_FOUND,
            GtaVKernelContractExports.Recv(socket.Context));
        Assert.Equal(ulong.MaxValue, socket.Context[CpuRegister.Rax]);
    ...
    public async Task SendCopiesGuestBytesToConnectedTcpAndInvalidFdFailsClosed()
    {
        ...
        Assert.Equal((int)OrbisGen2Result.ORBIS_GEN2_OK, GtaVKernelContractExports.Send(socket.Context));
        ...
        Assert.Equal(
            (int)OrbisGen2Result.ORBIS_GEN2_ERROR_NOT_FOUND,
            GtaVKernelContractExports.Send(socket.Context));
        Assert.Equal(ulong.MaxValue, socket.Context[CpuRegister.Rax]);
    }
    ...
    public void RecvAndSendWithUnmodeledFlagsReturnNotImplementedWithoutTouchingTheBuffer()
    {
        ...
        Assert.Equal(
            ...
            GtaVKernelContractExports.Recv(context));
        Assert.Equal(
            unchecked((ulong)(int)OrbisGen2Result.ORBIS_GEN2_ERROR_NOT_IMPLEMENTED),
            context[CpuRegister.Rax]);
        ...
        Assert.Equal(
            (int)OrbisGen2Result.ORBIS_GEN2_ERROR_NOT_IMPLEMENTED,
            GtaVKernelContractExports.Send(context));
        Assert.Equal(
            unchecked((ulong)(int)OrbisGen2Result.ORBIS_GEN2_ERROR_NOT_IMPLEMENTED),
            context[CpuRegister.Rax]);
    ...
    public async Task ShutdownRejectsInvalidHowWithoutStateChangeThenShutsDownBothDirections()
    {
        ...
        Assert.Equal(
            (int)OrbisGen2Result.ORBIS_GEN2_ERROR_INVALID_ARGUMENT,
            GtaVKernelContractExports.Shutdown(socket.Context));
        Assert.Equal(ulong.MaxValue, socket.Context[CpuRegister.Rax]);

        socket.Context[CpuRegister.Rsi] = 2;
        Assert.Equal((int)OrbisGen2Result.ORBIS_GEN2_OK, GtaVKernelContractExports.Shutdown(socket.Context));
        Assert.Equal(0UL, socket.Context[CpuRegister.Rax]);
    }
