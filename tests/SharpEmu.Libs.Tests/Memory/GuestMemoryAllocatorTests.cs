...
public sealed class GuestMemoryAllocatorTests
{
    ...
    public void FreedRangesAreReusedAndCoalesced()
    {
        ...
        // ShellCore's compatibility path expands the shared HLE allocation arena
        // to 64 MiB so its 16 MiB NP heap does not crowd out smaller objects.
        const ulong usableArenaSize = 0x0400_0000 - 0x1000;
