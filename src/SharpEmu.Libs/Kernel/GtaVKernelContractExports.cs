...
/// <summary>
/// Gen5-only libkernel/libScePosix registrations recovered from the GTA V import set.
...
/// </summary>
public static class GtaVKernelContractExports
{
    ...
    [SysAbiExport(
        ...
        LibraryName = "libkernel",
        PreferLle = false)]
    public static int CheckReachability(CpuContext ctx) => Deferred(ctx);
